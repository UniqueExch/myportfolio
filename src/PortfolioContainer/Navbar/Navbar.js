...
export default function Navbar() {
  return (
    <nav class="navbar navbar-expand-lg navbar-light colme text-light">
     <Link to = '/'><div class="nav-link text-light"><h1><stromg>UNIQUELORD</stromg></h1></div></Link>
      <div className='mybtn'>
      ...
      <ul class="navbar-nav">
             <li class="nav-item active shape">
             <Link to = '/'><div class="nav-link text-light"><strong>Home</strong></div></Link>
             </li>
             <li class="nav-item shape">
             <Link to = '/about'><div class="nav-link text-light"><strong>AboutMe</strong></div></Link>
             </li>
             <li class="nav-item shape">
             <Link to = '/resume'><div class="nav-link text-light"><strong>Resume</strong></div></Link>
             </li>
             <li class="nav-item shape">
             <Link to = '/projects'><div class="nav-link text-light"><strong>Projects</strong></div></Link>
             </li>
             <li class="nav-item shape">
             <Link to = '/contact'><div class="nav-link text-light"><strong>ContactMe</strong></div></Link>
             </li>
           </ul>
      </div>
    </nav>
